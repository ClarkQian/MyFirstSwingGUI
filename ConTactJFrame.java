...
public class ContactJFrame extends javax.swing.JFrame {
	...
	@SuppressWarnings("unchecked")
		...
		String emailpattern = ".+@.+";
		if (Pattern.matches(phonepattern, jTextField3.getText()) == false)
		{
			JOptionPane.showMessageDialog(this, "The phone number '" + jTextField3.getText() + "' is not created by numbers or '#+'", "ERROR", JOptionPane.ERROR_MESSAGE);
			return;
		}
		if (Pattern.matches(emailpattern, jTextField4.getText()) == false){
			JOptionPane.showMessageDialog(this, "The email address '" + jTextField4.getText() + "' is not the format of 'xxx@xxx'","ERROR", JOptionPane.ERROR_MESSAGE);
			return;
		}
