...
public class ContactJFrame extends javax.swing.JFrame {
        ...
        private void jTable1tableChanged(TableModelEvent evt){
                ...
                if(col == 2 && isPhoneValid(jTable1.getValueAt(row, col).toString()) == false)
                        jTable1.setValueAt(originalString, row, col);
                if(col == 3 && isEmailValid(jTable1.getValueAt(row, col).toString()) == false)
                        jTable1.setValueAt(originalString, row, col);
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
                ...
                for(int i = 0; i < dataVector.size(); i++){
                        ...
                        if (String.valueOf(dataVector.elementAt(i).get(0)).equals(jTextField1.getText())){
                                jTable1.setRowSelectionInterval(i, i);
                                String message = jTextField1.getText()+" has already in your contact";
        ...
        private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
                ...
                for(int i = 0; i < dataVector.size(); i++){
                        if (String.valueOf(dataVector.elementAt(i).get(0)).equals(jTextField5.getText())){
                                jTable1.setRowSelectionInterval(i, i);
                                Rectangle rect = jTable1.getCellRect(i, 0, true);
                                jTable1.scrollRectToVisible(rect);
                                break;
